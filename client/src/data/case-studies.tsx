...
export const caseStudies: CaseStudy[] = [
  {
    ...
    heroImage: "/Multipart Upload_cs.png",
    metrics: [
      { label: "Upload Speed", value: "Orders of magnitude faster" },
      { label: "Reliability", value: "Resumable & retry-safe" },
      { label: "File Size Support", value: "Multi-GB uploads" },
    ],

    overview:
      "A deep dive into architecting a resilient, high-concurrency multipart upload system that bypasses the backend to deliver massive files directly to S3, ensuring reliability even on unstable networks.",
    sections: [
      {
...
Backend -> S3: Complete Multipart Upload`,
  ...
  },
  {
    ...
    heroImage: "/Async Video Thumbnail Generation.png",
    metrics: [
      { label: "Processing Model", value: "Asynchronous & non-blocking" },
      { label: "Reliability", value: "Retry-safe, idempotent jobs" },
    ],

    overview:
      "A production-grade distributed system for generating video thumbnails asynchronously, ensuring zero impact on user upload latency while guaranteeing eventual consistency and fault tolerance.",
    sections: [
      {
        heading: "1. Problem Statement",
        subsections: [
