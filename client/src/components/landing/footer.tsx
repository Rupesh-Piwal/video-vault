  ...
  return (
    <footer className="bg-white pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-100 px-2 lg:px-0">
          <p className="text-sm text-gray-400 mb-4 md:mb-0">
            © {new Date().getFullYear()} VidVault. All rights reserved.
          </p>
          <div className="">
            <Link href="/https://github.com/Rupesh-Piwal/video-vault/blob/main/README.md" className="text-gray-400 hover:text-black transition-colors">
