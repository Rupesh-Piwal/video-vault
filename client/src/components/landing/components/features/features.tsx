                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      <div>
                        <AccordionTrigger className="pl-0 text-xl font-semibold tracking-wider">
                          {item.title}
                        </AccordionTrigger>

                        <AccordionTrigger className="justify-start pl-0 text-left text-[16px] leading-4 tracking-wider font-thin text-gray-300">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>
